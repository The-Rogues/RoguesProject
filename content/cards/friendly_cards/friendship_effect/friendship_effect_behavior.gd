...
func get_description(_instance:ActiveStatusEffect) -> String:
	...
	return "When this enemy's HP falls bellow [color=red]" + str(calc_threshold) + "[/color] percent, they immediatley flee combat. Threshold increases by [color=#43A047]3[/color] percent for each stack of [color=orange]friendship[/color]."
