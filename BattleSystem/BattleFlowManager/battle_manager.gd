...
const INTENT_ICON = preload("res://BattleSystem/Entities/ActionIntents/battle_intent_icon.tscn")
const BATTLE_ENTITY = preload("res://BattleSystem/Entities/Scenes/battle_entity.tscn")
