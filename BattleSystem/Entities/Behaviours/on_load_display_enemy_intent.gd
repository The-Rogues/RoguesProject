...
func _on_new_move_chosen(enemy_move:BattleMove):
	entity_instance.thought_context_popup.set_context(enemy_move.description)
	entity_instance.update_thought_icon(enemy_move.action_display_icon)
